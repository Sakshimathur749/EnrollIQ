      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Values aren&apos;t wall art here — they&apos;re the filter for every
            decision we make.
          </p>
        </motion.div>
          ...
          {values.map(({ icon: Icon, title, description, color }, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Number */}
                <span className="absolute top-6 right-7 text-5xl font-black text-foreground/4">
                  0{i + 1}
                </span>
                ...
                <h3 className="relative mb-3 text-base font-semibold text-foreground">
                  {title}
                </h3>
