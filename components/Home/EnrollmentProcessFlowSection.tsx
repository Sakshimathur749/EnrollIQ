...
const TABS: TabItem[] = [
  {
    ...
    description:
      "Online, offline, partner and campaign demand lands in one pipeline with its source intact.",
    bullets: [
      ...
      "Publisher API integration with real-time lead quality scoring.",
  ...
  },
  {
    ...
    description:
      "Reach prospects in seconds with automated drip sequences, AI telephony dialers, and conversational chatbots.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Transform complex enrollment forms into smooth, mobile-first applicant portals with live document verification.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Collect tuition fees, seat-booking deposits, and installments with integrated payment gateways and ERP sync.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Understand exactly which marketing campaigns, keywords, and counselors drive enrolled students and revenue.",
    bullets: [
...
export function EnrollmentProcessFlowSection() {
  ...
  return (
    <section
      className="py-20 lg:py-28 bg-white text-slate-900 overflow-hidden"
      id="enrollment-process-flow"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-4 mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-600 font-normal leading-relaxed max-w-3xl mx-auto pt-1">
            Bring marketing, admissions, applications, payments and student
            engagement together on one purpose-built enrollment platform.
          </p>
        </div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
                        ...
                        <div className="flex items-center gap-3 p-2.5 sm:p-3 rounded-xl bg-slate-50 border border-slate-100">
                          ...
                          <div>
                            ...
                            <div className="font-heading font-bold text-sm text-slate-900 mt-1">
                              1,245
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="relative w-24 h-24 shrink-0 flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                              <span className="font-heading font-black text-sm text-slate-900 leading-none">
                                842
                              </span>
                          ...
                          <div className="grid grid-cols-2 gap-x-3 gap-y-1.5 text-[10px] text-slate-600 flex-1">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              <span>
                                WhatsApp:{" "}
                                <strong className="text-slate-900">16%</strong>
                              </span>
                            </div>
                            <div className="flex items-center gap-1.5">
                  ...
                  <div className="space-y-4 animate-in fade-in zoom-in-95 duration-200">
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-indigo-50 space-y-4">
                      ...
                      <div className="space-y-2.5 bg-slate-50 p-4 rounded-xl">
                        <div className="bg-white p-3 rounded-2xl rounded-tl-xs shadow-xs text-xs text-slate-800 max-w-[85%] border border-slate-100">
                          Hi Aryan! 👋 Thank you for inquiring about B.Tech AI &
                          Data Science at Apex University. Here is your official
                          curriculum brochure & scholarship eligibility test
                          link.
                        </div>
                        <div className="bg-[#E7F8E8] p-3 rounded-2xl rounded-tr-xs shadow-xs text-xs text-slate-800 ml-auto max-w-[85%] border border-emerald-100">
                          Thanks! When is the next campus counseling batch
                          starting?
                        </div>
                      </div>
                      ...
                      <div className="p-3 bg-indigo-50 rounded-xl flex items-center justify-between text-xs">
                        <div className="flex items-center gap-2 text-indigo-900 font-semibold">
                          ...
                          <span>
                            AI Auto-Dialer Routed to Counselor: Sakshi Sharma
                          </span>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-white p-4 rounded-2xl shadow-xs border border-indigo-50">
                        ...
                        <div className="font-heading font-black text-lg text-slate-900 mt-1">
                          42 Seconds
                        </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="font-heading font-bold text-sm text-slate-900">
                            Applicant Portal Journey
                          </h4>
                          <span className="text-[11px] text-slate-500">
                            Candidate: Aryan Mehta (APP-2026-9812)
                          </span>
                        </div>
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-indigo-50 space-y-4">
                      <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                        <div>
                          ...
                          <span className="text-[11px] text-slate-500">
                            Live Gateway Sync (Razorpay & NEFT)
                          </span>
                        </div>
                      ...
                      <div className="space-y-2 text-xs">
                        <div className="flex items-center justify-between p-2.5 bg-slate-50 rounded-xl">
                          <div>
                            <div className="font-bold text-slate-800">
                              Sneha Roy • Semester 1 Tuition
                            </div>
                            <div className="text-[10px] text-slate-400">
                              UPI / QR Code • TXN #89124
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between p-2.5 bg-slate-50 rounded-xl">
                          <div>
                            <div className="font-bold text-slate-800">
                              Karan Verma • Hostel Booking
                            </div>
                            <div className="text-[10px] text-slate-400">
                              Net Banking • TXN #89125
                            </div>
                          </div>
                          <div className="text-right">
                            <div className="font-bold text-slate-900">
                      ...
                      <div className="p-3 bg-emerald-50 rounded-xl flex items-center justify-between text-xs text-emerald-800 font-semibold">
                        <div className="flex items-center gap-2">
                          <CheckCircle2 className="w-4 h-4 text-emerald-600" />
                          <span>
                            Auto-synced with ERP & GST Invoices generated
                          </span>
                        </div>
                        <span className="text-[10px] bg-white px-2 py-0.5 rounded shadow-xs font-bold">
                          100% Match
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-2xl p-5 shadow-sm border border-indigo-50 space-y-4">
                      ...
                      <div className="p-3 bg-purple-50 rounded-xl text-xs flex items-center justify-between text-purple-950 font-semibold">
                        <div className="flex items-center gap-2">
                          ...
                          <span>
                            AI Predicted Final Enrollments: 1,180 (±4%)
                          </span>
                        </div>
                      </div>
                    </div>
