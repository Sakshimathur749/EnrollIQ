...
export function WorkflowSection() {
  ...
  const steps = [
    {
      ...
      summary:
        "Leads from Meta Lead Gen, Google PMax, TikTok Instant Forms, and web landing pages trigger instant server-side ingestion with UTM token persistence.",
      details: [
    ...
    },
    {
      ...
      summary:
        "Before the student leaves their social feed, EduCRM dispatches a rich WhatsApp welcome message with the course syllabus PDF and masterclass invitation.",
      details: [
    ...
    },
    {
      ...
      summary:
        "Assigned admissions counselor receives an instant browser screen-pop and 1-click cloud telephony trigger with student profile and quiz scores.",
      details: [
    ...
    },
    {
      ...
      summary:
        "Students upload prior marksheets or transcripts via a secure mobile link. EduCRM validates credentials and computes eligible fee discounts.",
      details: [
    ...
    },
    {
      ...
      accentColor: "border-emerald-200 text-emerald-700 bg-emerald-50",
      summary:
        "Dynamic multi-currency payment links sent via SMS/WhatsApp. Upon tuition capture, student credentials are automatically provisioned in LMS.",
      details: [
  ...
  return (
    <section
      className="py-20 lg:py-28 bg-[#F8FAFC] text-slate-900 relative border-y border-slate-200"
      id="workflow"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
            From the initial Facebook ad click to verified classroom login in
            your LMS — every friction point is eliminated.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-3">
                  <span
                    className={`text-xs font-black px-2 py-0.5 rounded-md border ${step.accentColor}`}
                  >
                ...
                <div className="flex items-center gap-2.5 mb-2">
                  <div
                    className={`p-2 rounded-xl bg-slate-50 border border-slate-200 ${isSelected ? "text-[#2563EB]" : "text-slate-500"}`}
                  >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                <div className="lg:col-span-7 space-y-4">
                  <div className="flex items-center gap-2">
                    <span
                      className={`px-2.5 py-1 text-xs font-black rounded-lg border ${current.accentColor}`}
                    >
                ...
                <div className="lg:col-span-5 bg-slate-50 p-6 rounded-2xl border border-slate-200 space-y-4">
                  ...
                  <div className="p-3.5 rounded-xl bg-white font-mono text-xs text-slate-800 space-y-1.5 border border-slate-200 shadow-xs">
                    <div>
                      ...
                      <span>Ad_Lead_Created(utm_campaign)</span>
                    </div>
                    <div>
                      <span className="text-[#DC2626] font-bold">EXECUTE:</span>{" "}
                      <span>WhatsApp_Send_Brochure(template_v2)</span>
                    </div>
                    <div>
                      <span className="text-emerald-700 font-bold">
                        DISPATCH:
                      </span>{" "}
                      <span>AutoDialer.Route(counselor_top_performer)</span>
                    </div>
                    <div>
                      <span className="text-[#2563EB] font-bold">TIMEOUT:</span>{" "}
                      <span>If No Answer &gt; Trigger SMS Followup</span>
                    </div>
                  </div>
