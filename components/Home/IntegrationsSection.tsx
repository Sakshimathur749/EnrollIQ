  ...
  const products: ProductItem[] = [
    {
      ...
      badge: 'Zero Leakage',
      linkUrl: '/products/lead-management'
    },
    {
      id: 'lead-nurturing',
      name: 'Lead Nurturing',
      ...
      linkUrl: '/products/lead-nurturing'
    },
    {
      ...
      linkUrl: '/products/campaign-management'
    },
    {
      ...
      linkUrl: '/products/marketing-automation'
    },
    {
      id: 'user-management',
      ...
      badge: 'RBAC Security',
      linkUrl: '/products/user-management'
    },
    {
      id: 'publisher-panel',
      ...
      linkUrl: '/products/publisher-panel'
    },
    {
    ...
    },
    {
      ...
      badge: 'Executive BI',
      linkUrl: '/products/reports-analytics'
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14 sm:mb-16 space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto">
            From student lead acquisition to multi-channel nurturing and BI analytics—explore our 8 core enterprise modules designed for modern institutions.
          </p>
        </div>
              ...
              >
                <div>
                  ...
                  <div className="flex items-center justify-between gap-2 mb-4">
                    <div className={`w-12 h-12 rounded-xl ${prod.iconBg} border flex items-center justify-center transition-transform duration-300 group-hover:scale-105 shadow-2xs`}>
                      <Icon className={`w-6 h-6 ${prod.iconColor}`} strokeWidth={2.2} />
                    </div>
                    {prod.badge && (
                  ...
                  {/* Title */}
                  <h3 className={`font-heading font-bold text-base text-[#0F172A] ${prod.hoverColor} transition-colors leading-snug tracking-tight mb-2`}>
                    {prod.name}
                  </h3>
